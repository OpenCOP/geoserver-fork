...
public class CreateWebEOCLayerPage extends GeoServerSecuredPage {
    ...
    private String getDefaultLayerName() {
        ...
        String nameString = name.toString().replaceAll("[^A-Za-z0-9_\\s+]", "") // remove all weird characters
    ...
    private List<String> getIncidents() {
        List<String> strings = getWebEOC().getIncidents(credentials.getWebEOCCredentials()).getString();
