...
public class NetCDFReader extends AbstractGridCoverage2DReader implements GridCoverageReader {
    ...
    /*
     * In the future, the exact file inspector we use can be deteremined by a metadata file in the netcdf root directory, like if it's NRL formatted data, etc.
    ...
    public GridCoverage2D read(GeneralParameterValue[] params) throws IllegalArgumentException, IOException {
        ...
        /*
         * Our default "in the real world" is the current time and an elevation of 0
         * 
         */
